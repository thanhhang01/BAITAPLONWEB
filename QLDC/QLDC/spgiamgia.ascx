<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="spgiamgia.ascx.cs" Inherits="QLDC.spgiamgia" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;đ<asp:Label ID="Label3" runat="server" Text='<%# Eval("giamgia") %>' Font-Strikeout="True"></asp:Label>
                </td>
            </tr>
        </table>
    </ItemTemplate>
